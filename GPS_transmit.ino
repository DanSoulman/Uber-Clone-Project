...
HttpRequest request("https://uber-clone-project-484d8.firebaseio.com/Vehicles.json");
...
void loop()
{
  ...
  String req = "{\"Car-1\": {\"location\": {\"Latitude\":" + Lat + ",\"Longitude\":" + Lon + "}}}";
  req.toCharArray(myBuffer, 100);
